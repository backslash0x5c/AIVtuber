...
# キャラクター(persona.txt)を差し替えても常に適用される感情タグの指示
EMOTION_INSTRUCTION = """
返答の先頭に、今の感情を表すタグを必ず1つだけ付けてください。
使えるタグ: [neutral] [happy] [sad] [angry] [surprised] [shy]
例: [happy] コメントありがとうございます、嬉しいです。
タグは読み上げられないので、本文には感情の説明を書かないでください。
"""
